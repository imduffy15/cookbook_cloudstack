...
default['cloudstack']['systemvms'] = [
    {
        ...
        'url' => 'http://jenkins.buildacloud.org/view/4.3/job/cloudstack-4.3-systemvm64/lastSuccessfulBuild/artifact/tools/appliance/dist/systemvm64template-2014-09-30-4.3-xen.vhd.bz2',
    }
]
