...
UPDATE `cloud`.`vm_template` SET unique_name="Tiny linux",name="Tiny linux",url="http://10.0.2.2/ttylinux_pv.vhd",checksum="046e134e642e6d344b34648223ba4bc1",display_text="Tiny linux" where id=5;